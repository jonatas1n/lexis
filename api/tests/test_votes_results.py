...
from api.entities.votes_results import (
    CSV_FILE,
    VotesResultRepository,
    VotesResultServices,
    VotesResultController,
)
from api.entities.votes_results.controllers import NOT_FOUND_MESSAGE
from api.entities.votes_results.routes import router

mock_csv_data = "id,legislator_id,vote_id,vote_type\n1,101,201,1\n2,102,202,2\n"

app = FastAPI()
app.include_router(router, prefix="/votes_results")
...
def test_votes_results_repository_read_csv():
    ...
    with patch("builtins.open", mock_open(read_data=mock_csv_data)):
        with patch("api.entities.votes_results.repositories.CSV_FILE", CSV_FILE):
